...
% TODO: set wire type to classical, annotate measurement outcomes.

\begin{quantikz}
    \lstick{\ket{\psi}}          & \targ{}   & \qw      & \meter{} & \qw      & \ctrl{2} & \\
    \lstick[2]{\ket{\beta_{00}}} & \ctrl{-1} & \gate{H} & \meter{} & \ctrl{1} &          & \\
                                 & \qw       & \qw      & \qw      & \gate{Z} & \gate{X} & \rstick{\ket{\psi}}\qw
\end{quantikz}
